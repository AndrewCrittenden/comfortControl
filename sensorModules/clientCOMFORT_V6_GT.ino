...
responseData onDataRequest() {
    responseData data;
    double avg_raw = sum / (num_readings);
    ...
    double rt = (1980 * voltage) / (3.3 - voltage) - 4; //measured values of the resistance and voltage supplied instead of nominal
    Serial.print("GT res: ");
    Serial.println(rt);
    gt = 0.2585 * rt - 258.6; // given in manual `
    Serial.print("GT: ");
    Serial.println(gt);

    data.globeReading = gt;
  return data;
}
