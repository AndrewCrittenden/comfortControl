...
typedef struct pid_controller * progid_t;
...
extern "C" {
	 ...
	 *
	 * @return returns a progid_t controller handle
	 */
	progid_t pid_create(progid_t pid, float* in, float* out, float* set, float kp, float ki, float kd);
	 ...
	 */
	bool pid_need_compute(progid_t pid);
	 ...
	 */
	void pid_tune(progid_t pid, float kp, float ki, float kd);
	 ...
	 */
	void pid_sample(progid_t pid, uint32_t time);
	 ...
	 */
	void pid_limits(progid_t pid, float min, float max);
	 ...
	 */
	void pid_direction(progid_t pid, enum pid_control_directions dir);
