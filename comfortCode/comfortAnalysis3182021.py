...
indoorTemp= 79 #tdb, dry-bulb air temperature, [$^{\circ}$C], float
...
def comfortAnalysis(count, tdb, tg, rh, tout, occupancy):
    ...
    if tr <= 50 or tr >= 104:
        #error_6 = "Mean radiant temperature outside ASHRAE operating conditions"
        error_6 = True
        
    if tdb <= 50 or tdb >= 104:
        #error_7 = "Indoor temperature outside ASHRAE operating conditions" 
        error_7 = True
